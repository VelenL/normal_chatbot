...
# Load the data
with open("/Users/Shared/old/tbs/M2/project management/project_data_final_final.json") as file:
  data = json.load(file)
...
with open("/Users/Shared/old/tbs/M2/project management/stop-words.txt") as stop_words:
...
classifier.summary()
model1 = classifier.fit(X_train, y_train, epochs=5, shuffle = False)


#-------------------------------------------
input_user = "What is CAF?"
print(input_user)

# Create lists to store the tokens from the user_input
words_input =[]
